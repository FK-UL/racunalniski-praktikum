\begin{frame}{Logika in množice}
	\begin{enumerate}
		...
		Dokaži:
		\begin{itemize}
			\item \( (A \rightarrow B) \sim (\lnot B \rightarrow A)\) 
...
\begin{frame}{Analiza}
	\begin{enumerate}
		\item
		Pokaži, da je funkcija \( x \mapsto \sqrt{x}\) enakomerno zvezna na
		\( [0, \infty) \).
		\item 
		...
		$$ 
		\item
		Pokaži, da ima \( f(x) = 3x + \sin(2x) \) inverzno funkcijo in izračunaj 
		\( (f^{-1})' (3 \pi) \).
